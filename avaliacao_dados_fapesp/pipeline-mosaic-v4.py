...
if RODAR_CLUSTERING:
    ...
    for k in range(K_MIN, K_MAX + 1):
        r = clusterizar(k)
        if r is None:
            # k alto demais para a estrutura dos dados: registra e segue.
            # (o custo já costuma estar estagnado antes disso — cotovelo passou)
    ...
    # Usa K_ESCOLHIDO se convergiu; senão, o maior k disponível.
    ...
    K_ESCOLHIDO = k_usar   # reflete a escolha efetiva no resto do pipeline
